.. _everest_modules_handwritten_FilterModule:

..  This file is a placeholder for optional multiple files
    handwritten documentation for the FilterModule module.
...
:ref:`Link <everest_modules_FilterModule>` to the module's reference.
A Partner Module for the Everest Tutorial Module
